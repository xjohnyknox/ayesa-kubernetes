...
## Material-del-curso:
- [Enlace con videos del OneDrive](TBD)

> Videos de sólo consulta, no deja descargar.

- [Enlace con Documentación](TBD)
- [Enlace con formulario final de retroalimentación](TBD).
...
- [Plantilla Dracula](https://draculatheme.com/visual-studio-code)
- [Abrir VsCode desde terminal](https://www.freecodecamp.org/news/how-to-open-visual-studio-code-from-your-terminal/)
- [zsh + iconos](https://medium.com/@satriajanaka09/setup-zsh-oh-my-zsh-powerlevel10k-on-ubuntu-20-04-c4a4052508fd)
